trigger QuoteLineSyncTrigger on QuoteLineItem (before insert, after insert, after update) {
    ...
    /*add calvarez 22 dic 2016*/
    Map<String, Schema.SObjectField> fieldsqli = Schema.SObjectType.QuoteLineItem.fields.getMap();
                            ...
                            if (oliValue != qliValue) { 
                                ...
                                if (trigger.isInsert && (qliValue == null || (qliValue instanceof Boolean && !Boolean.valueOf(qliValue)))) {
                                    ...
                                    //if (qliValue == oldQliValue) {
                                        ...
                                        else if(fieldsqli.get(qliField).getDescribe().isUpdateable()) qli.put(qliField, oliValue);/*add isUpdateable() calvarez 22 dic 2016*/
                                        hasChange = true;
                                    //}     
